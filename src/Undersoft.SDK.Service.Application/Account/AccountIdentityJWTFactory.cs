...
public class AccountIdentityJWTFactory
{
    ...
    public AccountIdentityJWTFactory(Action<AccountIdentityJWTOptions> builder = null) : this(0, null)
    {
    ...
    public AccountIdentityJWTFactory(int minutesToExpire, AccountIdentityJWTOptions jwtOptions = null)
    {
        options = new AccountIdentityJWTOptions();
        if (jwtOptions != null)
            options = jwtOptions;
